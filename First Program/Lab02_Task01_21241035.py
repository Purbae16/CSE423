...
def mouseListener(button, state, x, y):	
    y = W_Height - y
    global status, b, points, a, c, ccol1, ccol2, ccol3, dcol1, dcol2, dcol3, speed, count
...
def collision_check():
    global status, a, b, c, points, dcol1, dcol2, dcol3, ccol1, ccol2, ccol3, count, speed
    catcher_leftx = 140 + c
...
wind = glutCreateWindow(b"Diamond Cat")
init()
